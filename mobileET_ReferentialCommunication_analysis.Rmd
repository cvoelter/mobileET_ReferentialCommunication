...
table(met.data$subject, met.data$experimenter)
```
...
#### Signalling - AoI Face - Experimenter
fit model
```{r}
mm1_signalling.face.exp=glmmTMB(prop_fixation_time.scaled ~ 
                             condition*experimenter+z.trial+z.session+z.age+sex +
                             (1|subject)+
                             (0+condition.c1|subject)+(0+condition.c2|subject)+ (0+condition.c3|subject)+(0+condition.c4|subject)+
                             (0+z.session|subject) + (0+z.trial|subject), #pruned to convergence issues
                           data=signalling.face.data, family=beta_family, control=contr)

summary(mm1_signalling.face.exp)
drop1(mm1_signalling.face.exp, test = "Chisq")
```
```{r}
mm1_signalling.face.exp2=glmmTMB(prop_fixation_time.scaled ~ 
                             condition+experimenter+z.trial+z.session+z.age+sex +
                             (1|subject)+
                             (0+condition.c1|subject)+(0+condition.c2|subject)+ (0+condition.c3|subject)+(0+condition.c4|subject)+
                             (0+z.session|subject) + (0+z.trial|subject), #pruned to convergence issues
...
summary(mm1_signalling.face.exp2)
drop1(mm1_signalling.face.exp2, test = "Chisq")
```
...
signalling.corr.bowl.data <- met.data %>%
  ...
  group_by(subject, session, trial, condition, age, sex, experimenter)%>%
  summarise(sum_fix_time=sum(fixation_time), sum_prop_fix_time= sum(prop_fixation_time))
...
#### Signalling - AoI correct Bowl - Experimenter impact

fit model
```{r}
mm1_signaling_correct_bowl_exp=glmmTMB(sum_prop_fix_time.scaled ~                                    condition*experimenter+z.trial+z.session+z.age+sex +
                                     (1|subject)+ (0+z.trial|subject)+
 (0+condition.c1|subject)+(0+condition.c2|subject)+ (0+condition.c3|subject)+(0+condition.c4|subject)+
                                     (0+z.session|subject),
                                   data=signalling.corr.bowl.data, family=beta_family, control=contr)

summary(mm1_signaling_correct_bowl_exp)
drop1(mm1_signaling_correct_bowl_exp, test="Chisq")
```

```{r}
mm1_signaling_correct_bowl_exp2=glmmTMB(sum_prop_fix_time.scaled ~                                    condition + experimenter+z.trial+z.session+z.age+sex +
                                     (1|subject)+ (0+z.trial|subject)+
 (0+condition.c1|subject)+(0+condition.c2|subject)+ (0+condition.c3|subject)+(0+condition.c4|subject)+
                                     (0+z.session|subject),
                                   data=signalling.corr.bowl.data, family=beta_family, control=contr)

summary(mm1_signaling_correct_bowl_exp2)
drop1(mm1_signaling_correct_bowl_exp2, test="Chisq")
```
